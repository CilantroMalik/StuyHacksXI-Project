      ...
      <div style={cardStyle}>
        <div style={{flex: 1, display: "flex", alignItems: "center", width: "100%"}}>
          <form style={{margin: "10px", display: "flex", flexDirection: "column", alignItems: "start", flex: 1}} onSubmit={submit}>
            ...
            {signUp ? <small className="mt-6"> Already have an account? <button onClick={() => navigate("/signin")} className="text-blue-600 hover:cursor-pointer font-bold">Login.</button></small>
                    : <small className="mt-6"> Don't have an account? <button onClick={() => navigate("/signup")} className="text-blue-600 hover:cursor-pointer font-bold">Sign Up.</button></small> }
